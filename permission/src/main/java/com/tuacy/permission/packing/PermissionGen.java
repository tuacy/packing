...
import com.tuacy.permission.packing.internal.Utils;
...
import static com.tuacy.permission.packing.internal.Utils.getActivity;
...
public class PermissionGen {
	...
	/**
	 * 注意这个函数一定要在Activity中重写onRequestPermissionsResult函数调用一次
	 */
	...
	/**
	 * 注意这个函数一定要在Fragment中重写onRequestPermissionsResult函数调用一次
	 */
